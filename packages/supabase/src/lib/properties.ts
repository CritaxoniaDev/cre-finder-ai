...
export class PropertyManager {
  ...
  async updateProperty(
    ...
    try {
      ...
      if (updates.property_type !== undefined)
        dbUpdates.property_type = updates.property_type;
      if (updates.status !== undefined) dbUpdates.status = updates.status;
      if (updates.price !== undefined) dbUpdates.price = updates.price;
      if (updates.price_type !== undefined)
        dbUpdates.price_type = updates.price_type;
      ...
      if (updates.square_feet !== undefined)
        dbUpdates.square_feet = updates.square_feet;
      if (updates.lot_size !== undefined) dbUpdates.lot_size = updates.lot_size;
      if (updates.address_line_1 !== undefined)
        dbUpdates.address_line_1 = updates.address_line_1;
      if (updates.address_line_2 !== undefined)
        dbUpdates.address_line_2 = updates.address_line_2;
      ...
      if (updates.year_built !== undefined)
        dbUpdates.year_built = updates.year_built;
      if (updates.property_features !== undefined)
        dbUpdates.property_features = updates.property_features;
      if (updates.images !== undefined) dbUpdates.images = updates.images;
      if (updates.documents !== undefined)
        dbUpdates.documents = updates.documents;
      if (updates.contact_info !== undefined)
        dbUpdates.contact_info = updates.contact_info as any;
      if (updates.is_featured !== undefined)
        dbUpdates.is_featured = updates.is_featured;
  ...
  async searchProperties(params: PropertySearchParams): Promise<{
    ...
    try {
      ...
      if (params.query) {
        query = query.or(
          `title.ilike.%${params.query}%,description.ilike.%${params.query}%,city.ilike.%${params.query}%`,
        );
      }
  ...
  async toggleFeatured(
    ...
    try {
      ...
      if (fetchError) {
        console.error(
          "Error fetching property for featured toggle:",
          fetchError,
        );
